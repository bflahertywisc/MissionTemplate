...
for "_i" from 1 to 4 do {_this addItemToVest "CUP_30Rnd_762x39_AK47_M";};
_this addBackpack "B_Carryall_cbr";
for "_i" from 1 to 2 do {_this addItemToBackpack "CUP_SMAW_HEAA_M";};
_this addItemToBackpack "CUP_SMAW_HEDP_M";
...
_this setSpeaker "cup_d_male01_cz";
